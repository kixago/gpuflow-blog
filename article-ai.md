...
All communication with me is in English regardless of whatever language you are on ... File names are the same (png's) ... Every single translation has the same file names across each language sitting in their respective directories ..  URL structure is gpuflow.app/ but the is blog.gpuflow.app/language/post ... Do not add the .md to any links! External links not associated with GPUFlow should be linked to their respective home page regardless of language as i have no control over that ..  Remember to follow the frontmatter, that this is an Astro blog, and SEO is most important to get visitors. If you have any questions before you get started, ask ... Never assume anything. Translate everything in alphabetical order starting with ar and soon until zh_tw
