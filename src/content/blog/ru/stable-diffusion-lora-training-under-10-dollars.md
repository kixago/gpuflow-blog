...
Начните с скромного набора данных из двадцати-тридцати изображений. Обучайте с консервативными настройками. Тщательно протестируйте результаты, прежде чем расширяться до более крупных проектов. Стоимость за попытку достаточно низкая, чтобы итерация была практичной—относитесь к первым нескольким запускам обучения как к опыту обучения, а не к производственным результатам. Этот же рабочий процесс применим к другим типам моделей. Если вы работаете с текстом вместо изображений, см. наше руководство по [тонкой настройке больших языковых моделей](/ru/private-llm-fine-tuning-guide) с использованием той же децентрализованной инфраструктуры GPU.
