...
**Privacidade e requisitos de verificação reduzidos.** Muitas plataformas GPU nativas de criptomoedas operam sem verificação KYC (Conheça Seu Cliente) obrigatória. Você pode alugar recursos computacionais usando apenas um endereço de carteira e saldo de criptomoeda. Isso atrai usuários preocupados com privacidade, indivíduos em regiões com infraestrutura bancária limitada e desenvolvedores que preferem transações pseudônimas. Pagamentos com criptomoedas permitem fluxos de trabalho impossíveis com bancos tradicionais. Por exemplo, você pode [treinar modelos LLM em conjuntos de dados sensíveis](/pt_br/private-llm-fine-tuning-guide) sem vincular sua identidade ao provedor de computação.
