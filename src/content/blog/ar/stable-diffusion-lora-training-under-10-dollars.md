...
ابدأ بمجموعة بيانات متواضعة من عشرين إلى ثلاثين صورة. تدرب بإعدادات متحفظة. اختبر نتائجك بدقة قبل التوسع في مشاريع أكبر. تكلفة المحاولة الواحدة منخفضة بما يكفي بحيث يكون التكرار عمليًا—معاملة جلسات التدريب الأولى كتجارب تعليمية بدلاً من مخرجات إنتاجية. ينطبق نفس سير العمل هذا على أنواع النماذج الأخرى. إذا كنت تعمل مع النصوص بدلاً من الصور، راجع دليلنا حول [ضبط نماذج اللغة الكبيرة](/ar/private-llm-fine-tuning-guide) باستخدام نفس البنية التحتية اللامركزية لـ GPU.
