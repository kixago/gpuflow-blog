...
התחל עם מערך נתונים צנוע של עשרים עד שלושים תמונות. אמן בהגדרות שמרניות. בדוק את התוצאות שלך ביסודיות לפני התרחבות לפרויקטים גדולים יותר. העלות לניסיון נמוכה מספיק כדי שאיטרציה תהיה מעשית—התייחס לריצות האימון הראשונות שלך כאל חוויות למידה במקום פלטי ייצור. אותו זרימת עבודה חלה על סוגי מודלים אחרים. אם אתה עובד עם טקסט במקום תמונות, ראה את המדריך שלנו על [כיוון מודלי שפה גדולים](/he/private-llm-fine-tuning-guide) באמצעות אותה תשתית GPU מבוזרת.
